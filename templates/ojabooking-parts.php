...
?>
    ...
    <form id="booking-filter" class="row g-3 needs-validation">
        <div class="col-auto">
            <div class="input-group" title="<?php _e('Date', 'ojabooking'); ?>">
        ...
        <div class="col">
            <div class="input-group" title="<?php _e('Select participants', 'ojabooking'); ?>">
                ...
                <label class="input-group-text selected-group" placeholder="<?php _e('Select participants', 'ojabooking'); ?>" aria-label="Example text with button addon" aria-describedby="button-select-group"></label>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php _e('Select participants', 'ojabooking'); ?></h5>
                    </div>
                    <div class="modal-body">
                        <?php ojabooking_get_template_part_select_categories(); ?>
                    </div>
                    <div class="modal-footer">
                        <button id="booking-group-select-btn" type="button" class="btn btn-primary" data-bs-dismiss="modal"><?php _e('Select', 'ojabooking'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="booking-contact-modal" class="modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php _e('Contact', 'ojabooking'); ?></h5>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button id="booking-contact-modal-btn" class="btn btn-primary" type="submit" data-bs-dismiss="modal"><?php _e('Book', 'ojabooking'); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
?>
    ...
    <div id="private-party-groups" class="mt-3 text-center">
        <div class="separator text-center my-3"><?php _e('Or', 'ojabooking'); ?></div>
        <?php foreach ($categories as $category) : ?>
            <div id="ojabooking_booking_category_<?php echo $category->term_id; ?>" class="private_party price_category">
                <button class="btn btn-secondary private-party-select" data-bs-dismiss="modal"><?php printf(esc_html__('Select %1$s', 'ojabooking'), $category->name); ?></button>
        ...
        <section class="booking container bg-content shadow rounded-3 p-3 mb-2">
            <div class="row">
                <div class="col">
                    ...
                    </svg><span class="time" title="<?php _e('Term', 'ojabooking'); ?>"></span>
                </div>
                <div class="col">
                    <div>
                        ...
                        <span class="vacancies" title="<?php _e('Vacancies', 'ojabooking'); ?>"></span>
                    </div>
                    <div>
                        ...
                        <span class="price" title="<?php _e('Your price', 'ojabooking'); ?>"></span>
                    </div>
                </div>
                <div class="col align-self-center">
                    <button class="btn btn-primary book" data-bs-toggle="modal" data-bs-target="#booking-contact-modal" event_id="" term=""><?php _e('Book', 'ojabooking'); ?></button>
                </div>
            </div>
        </section>
    </template>
